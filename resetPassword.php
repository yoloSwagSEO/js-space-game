	    ...
	    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
	    	...
	    	<?php if(isset($stop)){
				...
				<form role="form" method="post" action="" autocomplete="off">
					...
					<hr>
					<div class="row">
						<div class="col-xs-6 col-md-6"><button type="submit" name="submit" value="Change Password" class="button button-primary button-block button-lg" tabindex="3">Change Password</button></div>
					</div>
				</form>
