...
<div class="container">
	    ...
	    <div class="user_register">
			<form role="form" method="post" action="" autocomplete="off">
				...
				<table class="user-form-table">
					...
					<tr>
						<td>
							<button type="submit" name="submit" value="Sent Reset Link" class="button fill button-primary button-block button-lg" tabindex="2">Sent Reset Link</button>
						</td>
					</tr>
				</table>
			</form>
	...
	<?php include_once 'meta/cmi_left_index.php'; ?>
</div>
